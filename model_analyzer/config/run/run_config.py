...
class RunConfig:
    ...
    def bls_composing_configs(self):
        """
        Returns a list of BLS composing configs from the first model config
        (an ensemble cannot be part of a multi-model)
        """
        return self._model_run_configs[0].bls_composing_configs()
