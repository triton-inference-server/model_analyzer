...
class ConfigDictString(ConfigValue):
    """
    ...
    def __init__(self,
                 ...
                 name=None):
        """
        Instantiate a new ConfigDictString
        ...
        if validator is None:
            ...
            def validator(x):
                ...
                return ConfigStatus(
                    ...
                    f'The value for field "{self.name()}" should be a dict'
    ...
    def set_value(self, value):
        ...
        if self._is_string(value):
            ...
            #             f'"{self.name()}".', self)
            new_value.append(self._type(value))
        else:
