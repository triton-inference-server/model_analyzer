...
from .config_defaults import \
    ...
    DEFAULT_RUN_CONFIG_PROFILE_MODELS_CONCURRENTLY_ENABLE, DEFAULT_EARLY_EXIT_ENABLE, \
    ...
    def _add_run_search_configs(self):
        ...
        self._add_config(
            ConfigField(
                ...
                description=
                'Flag to indicate if Model Analyzer can skip some configurations when it is determined that throughput has plateaued'
            ))
        self._add_config(
            ConfigField(
