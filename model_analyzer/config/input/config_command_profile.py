...
from .config_defaults import \
    ...
    DEFAULT_PERF_ANALYZER_CPU_UTIL, DEFAULT_PERF_ANALYZER_MEASUREMENT_WINDOW, \
    DEFAULT_PERF_ANALYZER_PATH, DEFAULT_PERF_ANALYZER_TIMEOUT, \
    ...
    def _add_perf_analyzer_configs(self):
        ...
        self._add_config(
            ConfigField(
                ...
                field_type=ConfigPrimitive(float),
                default_value=DEFAULT_PERF_ANALYZER_CPU_UTIL,
                description=
        ...
        self._add_config(
            ConfigField(
                ...
                field_type=ConfigPrimitive(int),
                default_value=DEFAULT_PERF_ANALYZER_MEASUREMENT_WINDOW,
                description=
