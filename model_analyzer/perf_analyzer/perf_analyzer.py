...
class PerfAnalyzer:
    ...
    llm_metric_table = [
        ...
        ["time_to_first_token_p95", "Time to First Token (ns) p95",          TimeToFirstTokenP99, "1000"],
        ...
        ["time_to_first_token_p50", "Time to First Token (ns) p50",          TimeToFirstTokenP99, "1000"],
        ["time_to_first_token_p25", "Time to First Token (ns) p25",          TimeToFirstTokenP99, "1000"],
