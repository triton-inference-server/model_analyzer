...
class ExperimentEvaluator:
    ...
    def print_results(self):
        ...
        generator_best_measurement = (
            self._profile_data.get_best_run_config_measurement()
        )
        ...
        print(f"Generator num configs: {self._profile_data.get_model_config_count()}")
        print(
