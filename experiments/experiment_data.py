...
class ExperimentData:
    ...
    def _update_best_trackers(self, run_config, run_config_measurement):
        if self._best_run_config_measurement is None or \
            run_config_measurement.get_non_gpu_metric_value('perf_throughput') > self._best_run_config_measurement.get_non_gpu_metric_value('perf_throughput'):
