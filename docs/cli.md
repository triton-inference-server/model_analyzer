...
parameters](./config.md#model-config-parameters) (e.g. *max batch size*, *dynamic batch size*, and *instance count*), it will run tritonserver and perf analyzer instances with
