...
[Triton Model Repository](https://github.com/triton-inference-server/server/blob/r26.09/docs/user_guide/model_repository.md) that contains a simple libtorch model which calculates
