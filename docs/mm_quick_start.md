...
[Triton Model Repository](https://github.com/triton-inference-server/server/blob/r26.07/docs/user_guide/model_repository.md) that contains two libtorch models: `add_sub` & `resnet50_python`
