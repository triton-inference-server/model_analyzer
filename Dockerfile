...
ARG BASE_IMAGE=nvcr.io/nvidia/tritonserver:26.08-py3
ARG TRITONSDK_BASE_IMAGE=nvcr.io/nvidia/tritonserver:26.08-py3-sdk

ARG MODEL_ANALYZER_VERSION=1.57.0
ARG MODEL_ANALYZER_CONTAINER_VERSION=26.08
