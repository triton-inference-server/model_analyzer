...
ARG BASE_IMAGE=nvcr.io/nvidia/tritonserver:23.02-py3
ARG TRITONSDK_BASE_IMAGE=nvcr.io/nvidia/tritonserver:23.02-py3-sdk

ARG MODEL_ANALYZER_VERSION=1.26.0dev
ARG MODEL_ANALYZER_CONTAINER_VERSION=23.03dev
