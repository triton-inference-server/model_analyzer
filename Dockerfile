...
ARG BASE_IMAGE=nvcr.io/nvidia/tritonserver:22.11-py3
ARG TRITONSDK_BASE_IMAGE=nvcr.io/nvidia/tritonserver:22.11-py3-sdk

ARG MODEL_ANALYZER_VERSION=1.23.0dev
ARG MODEL_ANALYZER_CONTAINER_VERSION=22.12dev
