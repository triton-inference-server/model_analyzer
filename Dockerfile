...
ARG BASE_IMAGE=nvcr.io/nvidia/tritonserver:23.11-py3
ARG TRITONSDK_BASE_IMAGE=nvcr.io/nvidia/tritonserver:23.11-py3-sdk

ARG MODEL_ANALYZER_VERSION=1.34.0
ARG MODEL_ANALYZER_CONTAINER_VERSION=23.11
