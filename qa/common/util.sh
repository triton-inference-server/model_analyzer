...
function run_analyzer() {
    ...
    echo -e "=== Running $MODEL_ANALYZER $MODEL_ANALYZER_SUBCOMMAND $MODEL_ANALYZER_GLOBAL_OPTIONS $MODEL_ANALYZER_ARGS"
    $MODEL_ANALYZER $MODEL_ANALYZER_SUBCOMMAND $MODEL_ANALYZER_GLOBAL_OPTIONS $MODEL_ANALYZER_ARGS >> $ANALYZER_LOG 2>&1
    return $?
}
