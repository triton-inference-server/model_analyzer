...
QA_MODELS="ensemble_python_resnet50"
...
CONFIG_FILE="ensemble_python_resnet50.yaml"
...
MODEL_ANALYZER_ARGS="$MODEL_ANALYZER_ARGS --run-config-search-mode quick --latency-budget 2000"
