...
> The latest release of the Triton Model Analyzer is 1.39.0 and is available on branch
> [r24.04](https://github.com/triton-inference-server/model_analyzer/tree/r24.04).
