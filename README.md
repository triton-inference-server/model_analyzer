...
> The latest release of the Triton Model Analyzer is 1.35.0 and is available on branch
> [r23.12](https://github.com/triton-inference-server/model_analyzer/tree/r23.12).
