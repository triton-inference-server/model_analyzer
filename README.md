...
> The latest release of the Triton Model Analyzer is 1.44.0 and is available on branch
> [r24.09](https://github.com/triton-inference-server/model_analyzer/tree/r24.09).
