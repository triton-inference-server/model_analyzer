...
class TestRunConfigGenerator(trc.TestResultCollector):
    ...
    def test_none_result_in_max_batch_size(self):
        ...
        perf_throughput_values = [
            1,
            2,  # Default, Concurrency 1 and 2
            1,
            2,  # Instances=1, MaxBatch=1, Concurrency 1 and 2
            3,
            4,  # Instances=1, MaxBatch=2, Concurrency 1 and 2
            5,
            6,  # Instances=1, MaxBatch=4, Concurrency 1 and 2
            7,
            8,  # Instances=2, MaxBatch=1, Concurrency 1 and 2
            None,  # Instances=2, MaxBatch=2, Concurrency 1.
            9,
            10,  # Instances=3, MaxBatch=1, Concurrency 1 and 2
            11,
            12,  # Instances=3, MaxBatch=2, Concurrency 1 and 2
            13,
            14,  # Instances=3, MaxBatch=4, Concurrency 1 and 2
        ]
    ...
    def test_variant_naming(self):
        ...
        perf_throughput_values = [
            1,  # Default config
            1,
            None,  # A: 1 Instance, BS=1  B: 1 Instance, BS=1,2
            2,
            3,
            4,  # A: 1 Instance, BS=1  B: 2 Instance, BS=1,2,4
            5,
            6,
            7,  # A: 1 Instance, BS=2  B: 1 Instance, BS=1,2,4
            8,
            9,
            10,  # A: 1 Instance, BS=2  B: 2 Instance, BS=1,2,4
        ]
