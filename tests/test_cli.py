...
def get_test_options():
    ...
    options = [
        ...
        OptionStruct("int", "profile", "--run-config-search-min-request-rate-range", None, "2", "1024"),
        OptionStruct("int", "profile", "--run-config-search-max-request-rate-range", None, "100", "8192"),
