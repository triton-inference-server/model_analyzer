...
def get_test_options():
    ...
    options = [
        ...
        OptionStruct(
            "bool", "profile", "--run-config-profile-models-concurrently-enable"
        ),
        ...
        OptionStruct(
            "int", "profile", "--perf-analyzer-max-auto-adjusts", None, "100", "10"
        ),
        OptionStruct(
            "int", "profile", "--run-config-search-min-concurrency", None, "2", "1"
        ),
        OptionStruct(
            "int", "profile", "--run-config-search-max-concurrency", None, "100", "1024"
        ),
        OptionStruct(
            "int", "profile", "--run-config-search-min-request-rate", None, "2", "16"
        ),
        OptionStruct(
            "int",
            "profile",
        ...
        OptionStruct(
            "int",
            "profile",
            "--run-config-search-min-model-batch-size",
            None,
            "100",
            "1",
        ),
        ...
        OptionStruct(
            "int", "profile", "--run-config-search-min-instance-count", None, "2", "1"
        ),
        OptionStruct(
            "int", "profile", "--run-config-search-max-instance-count", None, "10", "5"
        ),
        OptionStruct(
            "int",
            "profile",
            "--run-config-search-max-binary-search-steps",
            None,
            "10",
            "5",
        ),
        OptionStruct(
            "int", "profile", "--min-percentage-of-search-space", None, "10", "5"
        ),
        OptionStruct(
            "int", "profile", "--max-percentage-of-search-space", None, "5", "10"
        ),
        OptionStruct("int", "profile", "--optuna-min-trials", None, "10", "20"),
        OptionStruct("int", "profile", "--optuna-max-trials", None, "5", "200"),
        OptionStruct(
            "int", "profile", "--optuna-early-exit-threshold", None, "5", "10"
        ),
        OptionStruct("float", "profile", "--monitoring-interval", "-i", "10.0", "1.0"),
        OptionStruct(
            "float",
            "profile",
            "--perf-analyzer-cpu-util",
            None,
            "10.0",
            str(psutil.cpu_count() * 80.0),
        ),
        ...
        OptionStruct(
            ...
            None,
            "./test_dir",
            os.path.join(os.getcwd(), "output_model_repository"),
            None,
        ),
        OptionStruct(
            "string",
        ...
        OptionStruct(
            "string", "profile", "--triton-output-path", None, "test_path", None, None
        ),
        OptionStruct(
            "string",
            "profile",
        ...
        OptionStruct(
            "string", "profile", "--export-path", "-e", "./test_dir", os.getcwd(), None
        ),
        OptionStruct(
            "string",
            "profile",
        ...
        OptionStruct(
            "string", "report", "--export-path", "-e", "./test_dir", os.getcwd(), None
        ),
        OptionStruct("string", "report", "--config-file", "-f", "baz", None, None),
        OptionStruct(
            "string",
            "profile",
            "--triton-docker-shm-size",
            None,
            "1G",
            None,
            extra_commands=["--triton-launch-mode", "docker"],
        ),
        OptionStruct(
            "string",
            "profile",
